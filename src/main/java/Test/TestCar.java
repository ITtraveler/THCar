...
public class TestCar {
	public static void main(String[] args) {
		...
		// log
		// boolean result2 = insertDao.insertOperatorLog(new
		// OperatorLog("2017-2-4
		// 14:25","18237603109",1,"","123457","18181818182","闽B84787","挪车","福州软件园"));
...
//		System.out.println(result3);
		...
		// car info
//		boolean result4 = insertDao.insertCarInfo(new CarInfo("123460", 2, "浙B49389", "临时停车，请见谅", "1823765637"));
//		System.out.println(result4);
		
		//share_Log
//		boolean result5 = insertDao.insertShareLog(new ShareLog(1,"2017-2-4 15:12","邀请好友，得20红包"));
